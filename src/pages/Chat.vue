                ...
                <div class="py-8 w-full mx-auto">
                    <div v-if="chat">
                        <div
                            ...
                            <p class="lg:text-lg">lastAccessed: <span class="text-green-500">{{ new Date(chat.lastAccessed).toLocaleString() }}</span></p>
                        ...
                        <div v-for="message in chat.messages.slice().reverse()">
                            <div class="w-full py-5 shadow-lg"
                                ...
                                <p class="max-w-3xl mx-auto text-end text-black dark:text-white text-xs">{{ new Date(message.time).toLocaleString()  }}</p>
                            </div>
                        </div>
                    </div>
                    <div v-else>
