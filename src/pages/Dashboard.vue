      ...
      <main>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="grid grid-cols-12 gap-6">
            ...
            <EngagementCard v-if="userEngagement" :user-engagement="userEngagement" />
            ...
            <CountryCard/>
            <!-- Table (Top Channels) -->
            <ActiveUsersCard v-if="userActivity" :userActivity="userActivity"/>
            <DashboardCard10 />
            <!-- <DashboardCard03 /> -->
            <DashboardCard07 />
            <DashboardCard02 />
...
import ActiveUsersCard from '../partials/dashboard/ActiveUsersCard.vue'
